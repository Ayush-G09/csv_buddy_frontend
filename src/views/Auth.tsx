...
function Auth() {
  ...
  const signup = async () => {
    ...
    const cnfPasswordIsValid =
      cnfPassword.value !== "" && cnfPassword.value === password.value;
        ...
        <Modal width="30vw" onClose={closeModal}>
          <React.Fragment>
            ...
            <>
              <Spacer
                type={"vertical"}
                value={state.modalChild === "Login" ? "2rem" : "1rem"}
              />
              <InputField
                width="70%"
                placeholder={"email"}
            ...
            <>
              ...
              <InputField
                ...
                onChange={(s) =>
                  setState((prev) => ({
                    ...prev,
                    password: { ...prev.password, value: s },
                  }))
                }
              />
              ...
              <>
                ...
                <InputField
                  ...
                  onChange={(s) =>
                    setState((prev) => ({
                      ...prev,
                      cnfPassword: { ...prev.cnfPassword, value: s },
                    }))
                  }
                />
